...
<body>
    <div class="container">
        ...
        <aside>
            ...
            <a href="/Association/Gestion/Activités/gestion_activites.php" class="nav-link current-page">
                <object type="image/svg+xml" data="/Association/assets/img/icone/house.svg" class="navbar-icon"></object>
            ...
            <a href="/Association/Activités/gestion_participants.php" class="nav-link">
                <object type="image/svg+xml" data="/Association/assets/img/icone/house.svg" class="navbar-icon"></object>
        ...
        <div class="xcontent">
            ...
            <h1 class="Title" class="hey">Ajouter une nouvelle activité</h1 class="Title"><br> <br>
            <div class="form">
            ...
            <br></br>
            <h1 class="Title"><br>Liste des Activités</h1 class="Title"><br>
